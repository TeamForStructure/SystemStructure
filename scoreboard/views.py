...
def goto_cycle(end_cycle, instructions):
    ...
    return insTable, funcUTable, registerTable
...
# 获取周期指令
class GetCycleView(GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        global instruction
        # print(cycle)
        insTable, funcUTable, registerTable = goto_cycle(int(cycle), instruction[0:-1])
